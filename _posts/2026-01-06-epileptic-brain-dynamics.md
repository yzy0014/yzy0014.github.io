...
<li><strong>351 misclassified frames</strong> out of 1995 total frames—predominantly transition frames between states, where misclassification often reflects ambiguities in human labeling rather than true model errors</li>
<li>Performance achieved through novel spatiotemporal preprocessing pipeline (TP - Temporal Pattern) that balances class representation</li>
</ul>

<h4 style="font-family:Times New Roman; font-size:0.9em; margin-top:1.5em;">Performance Comparison</h4>

<div style="margin-top:0.5em; margin-bottom:1em;">
The TP (Temporal Pattern) preprocessing pipeline—the same spatiotemporal feature extraction method developed in <a href="/Project/">Project 2</a>—demonstrates substantial performance advantages over DAT (raw calcium imaging data without preprocessing):
</div>

<table style="font-family:Times New Roman; font-size:0.7em; border-collapse:collapse; width:100%; margin-top:0.5em; margin-bottom:1.5em;">
<thead>
<tr style="border-bottom:2px solid #333;">
<th style="padding:0.5em; text-align:left;">Input Preprocessing</th>
<th style="padding:0.5em; text-align:center;">Overall Accuracy</th>
<th style="padding:0.5em; text-align:center;">Ictal Acc</th>
<th style="padding:0.5em; text-align:center;">Interictal Acc</th>
<th style="padding:0.5em; text-align:center;">Advantage</th>
</tr>
</thead>
<tbody>
<tr style="border-bottom:1px solid #ccc; background-color:#e8f5e9;">
<td style="padding:0.5em;"><strong>TP + Balanced</strong> ✅</td>
<td style="padding:0.5em; text-align:center;"><strong>82.6%</strong></td>
<td style="padding:0.5em; text-align:center;">71.3%</td>
<td style="padding:0.5em; text-align:center;">88.7%</td>
<td style="padding:0.5em; text-align:center;"><strong>+15.7% improvement</strong></td>
</tr>
<tr style="border-bottom:1px solid #ccc;">
<td style="padding:0.5em;">DAT + Balanced</td>
<td style="padding:0.5em; text-align:center;">66.9%</td>
<td style="padding:0.5em; text-align:center;">57.2%</td>
<td style="padding:0.5em; text-align:center;">71.8%</td>
<td style="padding:0.5em; text-align:center;">Baseline</td>
</tr>
</tbody>
</table>

<div style="font-size:0.7em; font-style:italic; margin-top:0.5em;">
<strong>Note:</strong> Both methods use balanced standardization during training. TP (Temporal Pattern) applies spatiotemporal feature extraction preprocessing before neural network input, while DAT uses raw calcium imaging data directly. The TP preprocessing results in 15.7% absolute improvement in overall accuracy and particularly strong gains in ictal state detection (+14.1%).
</div>
